...
fig = plt.figure()
sns.scatterplot(full_df, x=f"O3{units_dict['O3']}", y=f"NO2{units_dict['NO2']}", hue="Season")
plt.xticks(fontsize=12)
plt.title(f"Seasonal NO2 vs. O3 - {urban_area}")
plt.savefig(f"./Visualizations/{urban_area}pairwise_o3_no2.png")
